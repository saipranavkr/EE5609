...
\begin{align} \label{eq:eq_9}
    \myvec{1 & 0 & 1 \\ 1 & 1 & 0 \\ 0 & 1 & 1} \vec{x} = 0
\end{align}
By using the properties from \eqref{eq:eq_1} and reducing \eqref{eq:eq_9} to row echelon form,
\begin{align}
    \myvec{1 & 0 & 1 \\ 1 & 1 & 0 \\ 0 & 1 & 1} \xleftrightarrow[]{R_2\leftarrow R_1+R_2} \myvec{1 & 0 & 1 \\ 0 & 1 & 1 \\ 0 & 1 & 1 } \nonumber \\ \xleftrightarrow[]{R_3\leftarrow R_2+R_3} \myvec{1 & 0 & 1 \\ 0 & 1 & 1 \\ 0 & 0 & 0} \label{eq:eq_10}
\end{align}
From \eqref{eq:eq_10},
\begin{align} \label{eq:eq_11}
    a+c = 0; \quad b+c = 0
\end{align}
The solutions to \eqref{eq:eq_11} are,
\begin{align}
    a=b=c=0; \quad a=b=c=1
\end{align}
Since there is no trivial solution, $(\alpha + \beta)$, $(\beta + \gamma)$ and $(\gamma + \alpha)$ are linearly independent
\end{document}