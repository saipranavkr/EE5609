...
\begin{align}
    ...
    (a+c)\alpha + (a+b)\beta + (b+c)\gamma = 0 \label{eq:eq_5}
\end{align}
From \eqref{eq:eq_5}, since $\alpha$, $\beta$ and $\gamma$ are linearly independent vectors, hence the only solution is 
\begin{align}
    a+c = a+b = b+c = 0 \label{eq:eq_6}
\end{align}
From \eqref{eq:eq_1}, the possible values of $a, b, c$ are,
\begin{align}
    a = b = c = 0; \label{eq:eq_7} \\
    a = b = c = 1; \label{eq:eq_8}
\end{align}
If \eqref{eq:eq_8} is a solution, then \eqref{eq:eq_4}
\begin{align}
