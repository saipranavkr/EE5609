...
%
\section{Problem}
 For which value of \emph{k} will the following pair of linear equations have no solution

\begin{center}
(3   1)\textbf{x} = 1 \\
(2\emph{k}-1  \emph{k}-1)\textbf{x} = 2\emph{k}+1
\end{center}
%
%
\section{Solution}
...
From equation (2.0.3), it is clear that k = 2 
