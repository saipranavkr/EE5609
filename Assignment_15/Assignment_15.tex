...
\end{center}
\begin{abstract}
This document contains the concept similar matrices
\end{abstract}
...
\begin{align}
    ...
    \vec{B} = \myvec{e^{i\theta} & 0 \\ 0 & e^{-i\theta}} \label{eq:3_1}
\end{align}
...
\begin{align}
    ...
    &= 1+\lambda^2+2\lambda\cos{\theta} \label{eq:3_2}
\end{align}
...
\begin{align}
    ...
    \lambda_2 = \cos{\theta} - i \sin{\theta} \label{eq:3_3}
\end{align}
The eigenvectors corresponding to \eqref{eq:3_3} are,
\begin{align}
    \alpha_1 = \myvec{i \\ 1}; \: \alpha_2 = \myvec{-i \\ 1} \label{eq:3_4} \\
    \vec{P} = \myvec{\alpha_1 & \alpha_2} = \myvec{i & -i \\ 1 & 1} \label{eq:3_5} 
\end{align}
Now,
\begin{align}
    ...
    &= \myvec{e^{i\theta} & 0 \\ 0 & e^{-i\theta}} = \vec{B} \label{eq:3_6}
\end{align}
Hence, from \eqref{eq:3_6}, $\vec{A}$ and $\vec{B}$ are similar matrices. 
\end{document}