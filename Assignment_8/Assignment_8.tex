...
\begin{abstract}
This document explains QR decomposition of a matrix with an example
\end{abstract}
...
\begin{align}
    ...
    u_2 &= {\vec{q_2}^T\vec{b}} = \myvec{\frac{7}{\sqrt{65}} & -\frac{4}{\sqrt{65}}} \myvec{3 \\ 5} = \frac{1}{\sqrt{65}} \label{eq:eq_8}
\end{align}
Substituting \eqref{eq:eq_4} to \eqref{eq:eq_8} in \eqref{eq:eq_3}, \begin{align}
