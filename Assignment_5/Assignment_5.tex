...
\begin{abstract}
This document explains the concept of a property regarding triangles
\end{abstract}
...
Consider 2 matrices,
\begin{align}
    \vec{A} = \myvec{a_1 & a_2 & a_3} \quad and \quad \vec{B} = \myvec{b_1 & b_2 & b_3} \nonumber
\end{align}
The cross product of the 2 matrices is,
\begin{align} \label{eq:eq_1}
    \vec{A} \times \vec{B} = \myvec{0 & -a_3 & a_2 \\ a_3 & 0 & -a_1 \\ -a_2 & a_1 & 0} \myvec{b_1 \\ b_2 \\ b_3} 
\end{align} 
Substituting $a_3 = b_3 = 0$ in \eqref{eq:eq_1} and simplifying,
\begin{align}
...
\begin{figure}[!ht] \label{fig:triangle_abc}
\centering
\resizebox{5cm}{!}{\input{Assignment_5_TwoTriangles.tex}}
\caption{$\triangle ABC$ and $\triangle DBC$ with BC as common base}
\end{figure} \\
Since AD $\parallel$ BC,
\begin{align} \label{eq:eq_7}
    \vec{A} - \vec{D} = k(\vec{B} - \vec{C})
\end{align}
Now calculating the area of $\triangle DBC$,
\begin{align} \label{eq:eq_8}
    Area(\triangle DBC) = \frac{1}{2}\norm{(\vec{D} - \vec{B}) \times (\vec{C}- \vec{B})} 
\end{align}
Substituting \eqref{eq:eq_7} in \eqref{eq:eq_8},
\begin{align}
    \implies Area(\triangle DBC) = \frac{k}{2}\norm{\vec{D} \times (\vec{D}- \vec{A})} \nonumber \\
    \implies Area(\triangle DBC) = \frac{k}{2}\norm{\vec{A} \times \vec{D}} \label{eq:eq_9}\\  (\because \vec{A} \times \vec{A} = 0 ; \vec{A} \times \vec{B} = -(\vec{B} \times \vec{A}))\nonumber 
\end{align}
Substituting \eqref{eq:eq_7} in \eqref{eq:eq_5},
\begin{align}
    \implies Area(\triangle ABC) = \frac{k}{2}\norm{\vec{A}\times (\vec{D} - \vec{A})} \nonumber \\
    \implies Area(\triangle ABC) = \frac{k}{2}\norm{\vec{A}\times \vec{D}} \label{eq:eq_10}
\end{align}
It can be observed that \eqref{eq:eq_7} is equal \eqref{eq:eq_10}
