...
\end{figure} \\
Considering three points on a triangle as,
\begin{align}
    \vec{A}=\myvec{a_1 \\ a_2}, \vec{B} = \myvec{0 \\ 0}, \vec{C} = \myvec{c_1 \\ c_2}
\end{align}
\begin{align}
    \vec{A} - \vec{B} = \myvec{a_1 \\ a_2} - \myvec{0 \\ 0} = \myvec{a_1 \\ a_2} = \vec{A} \label{eq:eq_4}\\
    \vec{C} - \vec{B} = \myvec{c_1 \\ c_2} - \myvec{0 \\ 0} = \myvec{c_1 \\ c_2} = \vec{C} \label{eq:eq_5}
\end{align}
Area of triangle is,
